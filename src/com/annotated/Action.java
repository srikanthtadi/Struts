...
@RequiredStringValidator(type=ValidatorType.FIELD, trim=true, key="error.required",message="${getText(fieldName)} is required (message of annotation)")
...
@VisitorFieldValidator(appendPrefix=false,message="error occured",fieldName="user")
